class Planets {
  ...
  Planets({required this.name, required this.photo, required this.detalis});
}

List<Planets> planet = [
  Planets(
      name: 'Mercury',
      photo: 'assets/mercury.png',
      detalis:
